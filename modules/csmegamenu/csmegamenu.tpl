            ...
            <ul id="responsive-nav">
				...
				<li class="cog"><a href="{$link->getPageLink('identity', true)}">Mis datos personales</a></li>
					{if $typeOS == "Android" || $typeOS == "iPad" || $typeOS == "iPhone"}
						<li class="download-alt"><a title="{$typeOS}" href="{if $typeOS == 'Android'}https://play.google.com/store/apps/details?id=com.kubo.farmalisto&hl=es_419{else if $typeOS == 'iPad'}https://itunes.apple.com/co/app/compra-medicamentos-farmalisto/id911908649?mt=8{else if $typeOS == 'iPhone'}https://itunes.apple.com/co/app/farmalisto/id899599402?mt=8{else}javascript:;{/if}">Descarga nuestra aplicación</a></li>
					{/if}
				<li class="blog"><a href="http://blogdrogueria.farmalisto.com.co/" target="_blank">Blog</a></li>
