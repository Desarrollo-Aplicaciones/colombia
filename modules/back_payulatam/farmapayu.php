...
// Validacion de daqtos de respuesta del web service 
            ...
            if ($response['code'] == 'ERROR') {
                ...
                $conf->failed_transaction(0.0, $this->context->customer->id, $data, $response, 'Tarjeta_credito', 'code=ERROR', $this->context->cart->id);
                ...
                $conf->pago_payu($order['id_order'], $order['id_customer'], $data, $response, 'Tarjeta_credito', 'code=SUCCESS', $this->context->cart->id);
                ...
                $conf->failed_transaction(0.0, $this->context->customer->id, $data, $response, 'Tarjeta_credito', 'code=PAYU_WAITING_PAYMENT', $this->context->cart->id);
            } else {
                $conf->failed_transaction(0.0, $this->context->customer->id, $data, $response, 'Tarjeta_credito', 'Error indeterminado', $this->context->cart->id);
