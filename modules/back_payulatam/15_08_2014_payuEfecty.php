...
{
      $conf->failed_transaction(0, $this->context->cart->id_customer, $data, $response, 'Efecty', null);
...
$conf->pago_payu($order['id_order'], $order['id_customer'], $data, $response, 'Efecty', $extras);
