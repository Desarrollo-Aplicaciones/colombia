...
return $urlValidation='http://'.$_SERVER['HTTP_HOST'].$nombre_archivo.'/validationws.php';
  ...
  public function pago_payu($id_order,$id_customer,$json_request,$json_response,$method,$extras,$id_cart)
  {
      try {
  ...
  public function log_response_ws($str)
  {
      try {
      $mysqldate = date("Y-m-d H:i:s");
  ...
  public function failed_transaction($id_order,$id_customer,$json_request,$json_response,$method,$extras,$id_cart)
  {
