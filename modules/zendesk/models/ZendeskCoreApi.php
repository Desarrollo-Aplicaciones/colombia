...
class ZendeskCoreApi
{
    ...
    public function curlWrap($url, $array, $action, $end_user = false)
    {
        ...
        if (isset($decoded->error)) {
            ...
            PrestaShopLogger::addLog('Zendesk '.($decoded->description ? $decoded->description : $decoded->error), 1, null, 'ZendeskCoreApi', null, true, (int)Context::getContext()->employee->id);
            self::$error = array(
                'code' => $decoded->error,
