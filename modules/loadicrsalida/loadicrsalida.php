...
//    die();
    ...
    if (Tools::isSubmit('submitloadicrsalida')) {
      ...
      if ((($_FILES["fileloadicrsalida"]["type"] == "text/csv") || ($_FILES["fileloadicrsalida"]["type"] == "text/plain") || ($_FILES["fileloadicrsalida"]["type"] == "text/comma-separated-values") || ($_FILES["fileloadicrsalida"]["type"] == "application/csv") || ($_FILES["fileloadicrsalida"]["type"] == "application/excel") || ($_FILES["fileloadicrsalida"]["type"] == "application/vnd.ms-excel") || ($_FILES["fileloadicrsalida"]["type"] == "application/vnd.msexcel") || ($_FILES["fileloadicrsalida"]["type"] == "application/octet-stream") || ($_FILES["fileloadicrsalida"]["type"] == "text/anytext")) && ($_FILES["fileloadicrsalida"]["size"] < (1024 * 5000)) && in_array($extension, $allowedExts)) {
...
//    var_dump($output . $this->displayForm());
  ...
  public function displayForm() {
	...
	<p>Con este modulo usted podrá actualizar las ordenes de salida, recuerde que el archivo CSV debe tener los siguientes campos  <a href="../modules/loadicrsalida/formato.csv">(PEDIDO, FAC, ESTADO, FECHA, EAN, DESCRIPCION, CANTIDAD, PVP, TRANSPORTADORA, ICR)</a>, estos <b>deben estar</b> en la cabecera del archivo.</p>
