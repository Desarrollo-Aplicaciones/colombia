					...
					'{if $search_ssl == 1}{$link->getPageLink('search', true)|addslashes}{else}{$link->getPageLink('search')|addslashes}{/if}', {
						...
						if(data == "") {
							...
							for (var i = 0; i < data.length; i++) {
								...
								mytab[mytab.length] = { data: data[i], value: '<div class="busbig"><div class="bus_img_left"><div class="link_line_top_bus align_img_bus_bar"><a href="http://info.farmalisto.com/freestyle-libre/" ><img alt="farmalisto" src="' + data[i].imgs + '"></a></div></div><div class="bus_text line_top_bus_bar resp_bus_bar_no_4"><div class="text_probus_container"><a href="http://info.farmalisto.com/freestyle-libre/" class="link_line_top_bus">' + data[i].pname.toLowerCase()  + '</a></div></div><div class="bus_text line_top_bus_bar resp_bus_bar_4"><div class="text_probus_container"><a href="http://info.farmalisto.com/freestyle-libre/" class="link_line_top_bus">' + (data[i].pname).substring(0, 48).toLowerCase()  + '. . .</a></div></div><div class="bus_precio line_top_bus_bar"><div class="price_container"><a href="http://info.farmalisto.com/freestyle-libre/" class="link_line_top_bus"> $' + data[i].price + '&nbsp;</a></div></div><div class="bus_boton line_top_bus_bar"><div class="link_line_top_bus_2"><a href="http://info.farmalisto.com/freestyle-libre/"> <span class="bus_bar_span_agregar">Agregar</span> <img alt="farmalisto" src="/img/Carrito.png"> </a></div></div>'}; 
								} else {
