					...
					'{if $search_ssl == 1}{$link->getPageLink('search', true)|addslashes}{else}{$link->getPageLink('search')|addslashes}{/if}', {
						...
						if(data == "") {
							...
							for (var i = 0; i < data.length; i++) {
								...
								if ( data[i].id_product == 39493 ) {
								var rutaabbot = "'https://www.farmalisto.com.co/index.php?controller=order&submitReorder=&id_order=128494'";
								mytab[mytab.length] = { data: data[i], value: '<div class="busbig" onclick="cargaproduct('+rutaabbot+');"><div class="bus_img_left"><div class="link_line_top_bus align_img_bus_bar"><a href="http://info.farmalisto.com/freestyle-libre/" onclick="cargaproduct('+rutaabbot+');"><img alt="farmalisto" src="' + data[i].imgs + '"></a></div></div><div class="bus_text line_top_bus_bar resp_bus_bar_no_4"><div class="text_probus_container"><a href="http://info.farmalisto.com/freestyle-libre/" class="link_line_top_bus">' + data[i].pname  + '</a></div></div><div class="bus_text line_top_bus_bar resp_bus_bar_4"><div class="text_probus_container"><a href="http://info.farmalisto.com/freestyle-libre/" class="link_line_top_bus">' + (data[i].pname).substring(0, 48)  + '. . .</a></div></div><div class="bus_precio line_top_bus_bar"><div class="price_container"><a href="http://info.farmalisto.com/freestyle-libre/" class="link_line_top_bus"> $' + data[i].price + '&nbsp;</a></div></div><div class="bus_boton line_top_bus_bar" onclick="cargaproduct('+rutaabbot+');"><div class="link_line_top_bus_2" onclick="cargaproduct('+rutaabbot+');"><a href="http://info.farmalisto.com/freestyle-libre/" onclick="cargaproduct('+rutaabbot+');"> <span class="bus_bar_span_agregar" onclick="cargaproduct('+rutaabbot+');">Comprar</span> <img alt="farmalisto" src="/img/Carrito.png"> </a></div></div>'}; 
								} else if ( data[i].id_product == 39494 ) {
                                                                var rutaabbot = "'https://www.farmalisto.com.co/index.php?controller=order&submitReorder=&id_order=128496'";
                                                                mytab[mytab.length] = { data: data[i], value: '<div class="busbig" onclick="cargaproduct('+rutaabbot+');"><div class="bus_img_left"><div class="link_line_top_bus align_img_bus_bar"><a href="http://info.farmalisto.com/freestyle-libre/" onclick="cargaproduct('+rutaabbot+');"><img alt="farmalisto" src="' + data[i].imgs + '"></a></div></div><div class="bus_text line_top_bus_bar resp_bus_bar_no_4"><div class="text_probus_container"><a href="http://info.farmalisto.com/freestyle-libre/" class="link_line_top_bus">' + data[i].pname  + '</a></div></div><div class="bus_text line_top_bus_bar resp_bus_bar_4"><div class="text_probus_container"><a href="http://info.farmalisto.com/freestyle-libre/" class="link_line_top_bus">' + (data[i].pname).substring(0, 48)  + '. . .</a></div></div><div class="bus_precio line_top_bus_bar"><div class="price_container"><a href="http://info.farmalisto.com/freestyle-libre/" class="link_line_top_bus"> $' + data[i].price + '&nbsp;</a></div></div><div class="bus_boton line_top_bus_bar" onclick="cargaproduct('+rutaabbot+');"><div class="link_line_top_bus_2" onclick="cargaproduct('+rutaabbot+');"><a href="http://info.farmalisto.com/freestyle-libre/" onclick="cargaproduct('+rutaabbot+');"> <span class="bus_bar_span_agregar" onclick="cargaproduct('+rutaabbot+');">Comprar</span> <img alt="farmalisto" src="/img/Carrito.png"> </a></div></div>'};
                                                                } else{
								mytab[mytab.length] = { data: data[i], value: '<div class="busbig"><div class="bus_img_left"><div class="link_line_top_bus align_img_bus_bar"><a href="' + data[i].product_link + '" onclick="cargaproduct(this);"><img alt="farmalisto" src="' + data[i].imgs + '"></a></div></div><div class="bus_text line_top_bus_bar resp_bus_bar_no_4"><div class="text_probus_container"><a href="' + data[i].product_link + '" class="link_line_top_bus" onclick="cargaproduct(this);">' + data[i].pname  + '</a></div></div><div class="bus_text line_top_bus_bar resp_bus_bar_4"><div class="text_probus_container"><a href="' + data[i].product_link + '" class="link_line_top_bus" onclick="cargaproduct(this);">' + (data[i].pname).substring(0, 48) + '. . .</a></div></div><div class="bus_precio line_top_bus_bar"><div class="price_container"><a href="' + data[i].product_link + '" class="link_line_top_bus" onclick="cargaproduct(this);"> $' + data[i].price + '&nbsp;</a></div></div><div class="bus_boton line_top_bus_bar"><div class="link_line_top_bus_2"><a href="index.php?controller=cart&add=1&qty=1&id_product=' + data[i].id_product + '&token=2e617d6e25442930c5c02a6881704405"" rel="ajax_id_product_' + data[i].id_product + '" onclick="cargaproduct(this);"> <span class="bus_bar_span_agregar">Agregar</span> <img alt="farmalisto" src="/img/Carrito.png"> </a></div></div>'}; 
                                }
							}
...
<script type="text/javascript">
	...
	function ver_mas_bus_bar(object) {
		...
		document.getElementById('submit_search_bus_bar').click();
	}
