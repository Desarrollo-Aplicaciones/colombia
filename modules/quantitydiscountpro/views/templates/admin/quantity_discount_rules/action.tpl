    ...
    <div class="row">
        <div class="col-lg-2">
            <a class="btn btn-default" id="action_condition_remove_button[{$action->id_quantity_discount_rule_action|intval}]" href="javascript:removeActionProduct('{$action->id_quantity_discount_rule_action|intval}');">
                <i class="icon-remove text-danger"></i> {l s='Remove product' mod='quantitydiscountpro'}
            </a>
        </div>
        <div class="col-lg-10">
            <div class="form-group">
                ...
                <div class="col-lg-11">
                    <select name="action_id_type[{$action->id_quantity_discount_rule_action|intval}]">
                        ...
                        <optgroup label="{l s='WebImpacto' mod='quantitydiscountpro'}">
                            <option value="400" {if isset($action->id_type) && $action->id_type|intval == 400}selected="selected"{/if}>{l s='Tramos con Ciclo' mod='quantitydiscountpro'}</option>
                        </optgroup>
                    </select>
                </div>
            </div>
                ...
                <div class="col-lg-11 col-lg-offset-1">
                    <div class="row row-margin-top">
                        <label class="control-label col-lg-3">
                            ...
                            <span id="action_condition_buy_label_5[{$action->id_quantity_discount_rule_action|intval}]">{l s='Número Ciclos' mod='quantitydiscountpro'}</span>
                        </label>
                        <div class="col-lg-9">
                            <div class="input-group">
                                <input type="text" id="action_products_nb_each" name="action_products_nb_each[{$action->id_quantity_discount_rule_action|intval}]" value="{$action->products_nb_each|intval}" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        {assign var=reduction_percent_ciclos value=","|explode:"{$action->reduction_percent_ciclos}"}
        <div class="form-group" id="action_condition_tramos_value[{$action->id_quantity_discount_rule_action|intval}]">
            {for $foo=1 to $action->products_nb_each|intval}
            <div class="col-lg-11 col-lg-offset-1" num-ciclo="{$foo}">
                <div class="row row-margin-top">
                    <label class="control-label col-lg-3">
                        <span id="action_tramos_condition_value_label_1[{$action->id_quantity_discount_rule_action|intval}]">{l s='Porcentaje Descuento - Tramo' mod='quantitydiscountpro'} <span class="spam-num-tramo">{$foo}</span> </span>
                    </label>
                    <div class="col-lg-9">
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="input-group">
                                    <span class="input-group-addon">%</span>
                                    <input type="text" id="action_tramos_reduction_percent[{$action->id_quantity_discount_rule_action|intval}]" class="input-mini" name="action_reduction_percent_ciclos[{$action->id_quantity_discount_rule_action|intval}][]" value="{$reduction_percent_ciclos.{$foo-1}}" />
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <select name="action_tramos_reduction_percent_tax[{$action->id_quantity_discount_rule_action|intval}]" data-group="tax[{$action->id_quantity_discount_rule_action|intval}]">
                                    <option value="1" {if $action->reduction_percent_tax == 1}selected="selected"{/if}>{l s='Tax included' mod='quantitydiscountpro'}</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="col-lg-11 col-lg-offset-1">
                    <div class="row row-margin-top">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-lg-12 help-block">{l s='If enabled, the percentage will be computed from the regular product price without any specific price'  mod='quantitydiscountpro'}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group" id="action_condition_product_maximum_amount[{$action->id_quantity_discount_rule_action|intval}]">
                <div class="col-lg-11 col-lg-offset-1">
                    <div class="row row-margin-top">
                        <label class="control-label col-lg-3">{l s='Voucher maximum amount per product unit' mod='quantitydiscountpro'}</label>
                        <div class="col-lg-9">
                            <div class="row">
                                <div class="col-lg-2">
            ...
            <div class="form-group" id="action_condition_consider_only_default_category[{$action->id_quantity_discount_rule_action|intval}]">
                <div class="col-lg-11 col-lg-offset-1">
                    <div class="row row-margin-top">
                        <label class="control-label col-lg-3">{l s='Consider only the product default category' mod='quantitydiscountpro'}</label>
                        <div class="col-lg-9">
                            <div class="input-group">
            ...
            <div class="form-group" id="action_condition_repeat[{$action->id_quantity_discount_rule_action|intval}]">
                <div class="col-lg-11 col-lg-offset-1">
                    <div class="row row-margin-top">
                        <label class="control-label col-lg-3">{l s='Times to repeat the discount' mod='quantitydiscountpro'}</label>
                        <div class="col-lg-9">
                            <p class="radio">
                                <label for="nb_repetitions_infinite">
                                    <input type="radio" name="action_nb_repetitions[{$action->id_quantity_discount_rule_action|intval}]" id="nb_repetitions_infinite" value="infinite" {if $action->nb_repetitions == 'infinite'}checked="checked"{/if} />
                            ...
                            <p class="radio">
                                <label for="nb_repetitions_custom">
                                    <input type="radio" name="action_nb_repetitions[{$action->id_quantity_discount_rule_action|intval}]" id="nb_repetitions_custom" value="custom" {if $action->nb_repetitions == 'custom'}checked="checked"{/if} />
                    ...
                    <div class="row row-margin-top">
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 help-block">
                                        {l s='If there are more products to apply discount than limit, products will be sort by this criteria' mod='quantitydiscountpro'}<br />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="form-group" id="action_condition_filters[{$action->id_quantity_discount_rule_action|intval}]">
                <div class="col-lg-11 col-lg-offset-1">
                    <div class="panel">
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 help-block">{l s='If disabled, any addition discount will be applied to these products and they will not computed in rules' mod='quantitydiscountpro'}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <tr>
                                                    <td class="col-xs-6">
                                                        ...
                                                        <select id="product_select_1_{$action->id_quantity_discount_rule_action|intval}" class="input-large" multiple>
                                                            {foreach from=$action->product.unselected item='product'}
                                                                <option value="{$product.id_product|intval}">&nbsp;{$product.name|escape:'html':'UTF-8'} (ID: {$product.id_product|intval})</option>
                                                            {/foreach}
                                                        </select>
                                                    ...
                                                    <td class="col-xs-6">
                                                        ...
                                                        <select name="action_product_select[{$action->id_quantity_discount_rule_action|intval}][]" id="product_select_2_{$action->id_quantity_discount_rule_action|intval}" class="input-large" multiple>
                                                            {foreach from=$action->product.selected item='product'}
                                                                <option value="{$product.id_product|intval}">&nbsp;{$product.name|escape:'html':'UTF-8'} (ID: {$product.id_product|intval})</option>
                                                            {/foreach}
                                                        </select>
                                            ...
                                            <tr>
                                                <td class="col-xs-6">
                                                    ...
                                                    <select id="attribute_select_1_{$action->id_quantity_discount_rule_action|intval}" class="input-large" multiple>
                                                        {foreach from=$action->attribute.unselected item='attribute'}
                                                            <option value="{$attribute.id_attribute|intval}">&nbsp;{$attribute.name|escape:'html':'UTF-8'} (ID: {$attribute.id_attribute|intval})</option>
                                                        {/foreach}
                                                    </select>
                                                ...
                                                <td class="col-xs-6">
                                                    ...
                                                    <select name="actionattribute_select[{$action->id_quantity_discount_rule_action|intval}][]" id="attribute_select_2_{$action->id_quantity_discount_rule_action|intval}" class="input-large" multiple>
                                                        {foreach from=$action->attribute.selected item='attribute'}
                                                            <option value="{$attribute.id_attribute|intval}">&nbsp;{$attribute.name|escape:'html':'UTF-8'} (ID: {$attribute.id_attribute|intval})</option>
                                                        {/foreach}
                                                    </select>
                                            ...
                                            <tr>
                                                <td class="col-xs-6">
                                                    ...
                                                    <select id="category_select_1_{$action->id_quantity_discount_rule_action|intval}" class="input-large" multiple>
                                                        {foreach from=$action->category.unselected item='category'}
                                                            <option value="{$category.id_category|intval}">&nbsp;{$category.name|escape:'html':'UTF-8'} (ID: {$category.id_category|intval})</option>
                                                        {/foreach}
                                                    </select>
                                                ...
                                                <td class="col-xs-6">
                                                    ...
                                                    <select name="actioncategory_select[{$action->id_quantity_discount_rule_action|intval}][]" id="category_select_2_{$action->id_quantity_discount_rule_action|intval}" class="input-large" multiple>
                                                        {foreach from=$action->category.selected item='category'}
                                                            <option value="{$category.id_category|intval}">&nbsp;{$category.name|escape:'html':'UTF-8'} (ID: {$category.id_category|intval})</option>
                                                        {/foreach}
                                                    </select>
                        ...
                        {if $action->supplier.unselected|@count + $action->supplier.selected|@count > 0}
                            <div class="row row-margin-top">
                        ...
                        {if $action->manufacturer.unselected|@count + $action->manufacturer.selected|@count > 0}
                            <div class="row row-margin-top">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-5">
                        ...
                        <div class="row row-margin-top">
                            ...
                            <div class="col-lg-12">
                                <div class="row row-margin-top">
                                    <div class="col-lg-5">
                                        <label class="control-label">{l s='Only consider products with this price' mod='quantitydiscountpro'}</label>
                                    </div>
                                    <div class="col-lg-1">
                                        <select name="action_product_price_operator[{$action->id_quantity_discount_rule_action|intval}]">
                                            <option value="0" {if $action->product_price_operator|intval == 0}selected="selected"{/if}>>=</option>
                                            <option value="1" {if $action->product_price_operator|intval == 1}selected="selected"{/if}>=</option>
                                            <option value="2" {if $action->product_price_operator|intval == 2}selected="selected"{/if}><=</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-2">
                                        <input type="text" name="action_product_price_amount[{$action->id_quantity_discount_rule_action|intval}]" value="{$action->product_price_amount|floatval}" />
                                    </div>
                                    <div class="col-lg-2">
                                        <select name="action_product_price_currency[{$action->id_quantity_discount_rule_action|intval}]">
                                        {foreach from=$currencies item='currency'}
                                            <option value="{$currency.id_currency|intval}"
                                            {if $action->product_price_currency|intval == $currency.id_currency
                                                || (!$action->product_price_currency|intval && $currency.id_currency == $defaultCurrency)}
                                                selected="selected"
                                            {/if}
                                            >
                                    ...
                                    <div class="col-lg-2">
                                        <select name="action_product_price_tax[{$action->id_quantity_discount_rule_action|intval}]">
                                            <option value="0" {if $action->product_price_tax|intval == 0}selected="selected"{/if}>{l s='Tax excluded' mod='quantitydiscountpro'}</option>
                                            <option value="1" {if $action->product_price_tax|intval == 1}selected="selected"{/if}>{l s='Tax included' mod='quantitydiscountpro'}</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('select[name="action_id_type{/literal}[{$action->id_quantity_discount_rule_action|intval}{literal}]"], [name^=action_nb_repetitions], [name^=action_group_products_by]').each(function() {
    ...
    $('#action_products_nb_each').on('input', function() {
        var val = parseInt($('#action_products_nb_each').val());

        $("[num-ciclo]").filter(function() {
            if(!val || val<1){ val = 1; }
            return parseInt($(this).attr("num-ciclo")) > val;
        }).remove();


        for (var i=$('[num-ciclo]').length+1; i<=val; i++) {
            console.log(i);
            $('[num-ciclo=1]').clone().attr('num-ciclo',i).appendTo($('div[id^=action_condition_tramos_value]'));
            $('[num-ciclo='+i+']').find('span.spam-num-tramo').html(i);
        }
    })
