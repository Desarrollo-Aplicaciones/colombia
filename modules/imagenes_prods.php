...
$fileAttachment['name'] = "Reporte_imagenes_Colombia.xls";
$fileAttachment['mime'] = "application/vnd.ms-excel";

$correos = array("andrea.pena@farmalisto.com.co", "ewing.vasquez@farmalisto.com.co", "helmer.quintero@farmalisto.com.co");
/*
echo "<pre>mails: ";
print_r($correos);
print_r($nombres);
