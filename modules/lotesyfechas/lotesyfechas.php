	...
	public function getContent()
    {
        ...
        if (Tools::isSubmit('submitUpdateDate'))
        {
            if (Tools::getValue('icr') && (
                ...
                Tools::getValue('Year') && Tools::getValue('Day')) || Tools::getValue('regsani') || Tools::getValue('fechanoaplica') ) )
            {
                ...
                if ($idicr)
                {
                    ...
                    } elseif ( Tools::getValue('Year') && Tools::getValue('Month') && Tools::getValue('Day') ) {
                        
                        if ( strlen(Tools::getValue('Day') ) == 1  ) {
