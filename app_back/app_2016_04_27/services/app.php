...
private function cart(){
	...
	$model = new Model();
	return $this->response($this->json($model->cart($param['products'],$param['id_customer'],$param['id_address'],$param['discounts'],$param['deleteDiscount'])),200);
}
/**
 * 
 */
...
public function addImg(){
	...
	$model = new Model();
	$this->response(json_encode( $model->add_formula($str_img)),200);
}
