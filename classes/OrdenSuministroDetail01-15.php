...
echo $query="select COUNT(1) as total, icr.id_icr, icr.cod_icr,s_order_d.name,s_order_d.reference,s_order_d.id_product from ps_supply_order_detail  orderdtl 
