					...
					// 	print_r($cart_rule['obj']->id);
					 //	echo '<br>alias ';
						...
						// echo '<br>';
									...
									if($opera == 1){if($address == 'BOGOTá, D.C.'){	if($addre == 'FARMALISTO'){}
										}
									}
									else{
											if($address == 'BOGOTá, D.C.'){	
												if($addre == 'FARMALISTO'){
													 if($cartruller == ""){
													 $order->total_discounts_tax_excl = $order->total_paid_tax_excl - $order->total_shipping;
													$order->total_discounts = $order->total_discounts_tax_excl;
													$order->total_paid = $order->total_discounts;
													$order->total_paid_tax_excl = $order->total_discounts_tax_excl;
													$order->total_paid_tax_incl = $order->total_discounts_tax_excl;
													$order->total_paid_real = $order->total_discounts;
													}
												}
											}
