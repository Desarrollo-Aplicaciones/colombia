...
<audio id="alert_producto" src="http://<?php echo $host; ?>sound/beam.wav" type="audio/wav"></audio>  
<audio id="alert_irc" src="http://<?php echo $host; ?>sound/beam.wav" type="audio/wav"></audio> 
<audio id="alert_irc_list" src="http://<?php echo $host; ?>sound/beam.wav" type="audio/wav"></audio> 
<audio id="product_not_in_order" src="http://<?php echo $host; ?>sound/product_not_in_order.mp3" type="audio/mp3"></audio>
...
$("#icrstable").append("<tr><td>"+ retornado[2] +"</td><td>"+ retornado[3] +"</td><td>"+ count_icr +" <input readonly type='text' name='pri"+ "[]' value='" + retornado[1] + "'> <a class=\"quitaicr\" id=\""+ retornado[1] +"|"+retornado[4]+ "\"  href='#'> X </a> </td></tr>");
     ...
     ordenCompletaGuargar();
         ...
         alert("Tu orden contiene todos los elementos de este producto: ("+retornado[2]+")." );
     }
