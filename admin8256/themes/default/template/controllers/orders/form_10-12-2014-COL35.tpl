...
<script type="text/javascript">
	...
	function displaySummary(jsonSummary)
	{
		...
		if (jsonSummary.summary.validacartrule == "true"){
			totalsinivadescuento = (jsonSummary.summary.total_price_without_tax - jsonSummary.summary.total_discounts_tax_exc + parseInt(jsonSummary.summary.total_shipping_tax_exc));
			totalsinivadescuento = totalsinivadescuento.toString();
			totalsinivadescuento = totalsinivadescuento.replace(".",",");
