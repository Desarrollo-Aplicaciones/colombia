	...
	<div class="auth_header">
		<div class="block_permanent_links">
				<p id="header_link_contact">
					<span>Línea de atención y ventas:</span>
					<a class="number" href="tel:+5714926363">Bogotá: (+57 1) 492 6363</a> | 
					<a class="number" href="tel:+5728912562">Cali: (+57 2) 891 2562</a> |
					<a class="number" href="tel:+5742040695">Medellín: (+57 4) 204 0695</a> |
					<a class="number" href="tel:+5753851691">Barranquilla: (+57 5) 385 1691</a> |
					<a class="number" href="tel:018009133830">Nacional: 01 800 913 3830</a>
				</p>
		</div>
...
<div class="contenido">
	<p style="color:#fff">IP: -{$smarty.server.REMOTE_ADDR}-{if $smarty.server.REMOTE_ADDR eq '192.168.10.83'} ---- {/if}</p>
	{$HOOK_LOGINIZQ}
		...
		<form action="{$link->getPageLink('authentication', true)}"
			...
			<fieldset>
				...
				<div class="TOS">
					...
					<div class="TOSlegend">Confirmo que soy mayor de edad y acepto <a href="{$base_uri}?id_cms=3&controller=cms" target="blank">los términos y las condiciones</a> legales y la autorización habeas data.</div>
