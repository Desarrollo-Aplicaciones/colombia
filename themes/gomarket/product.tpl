...
<div class="contenido_producto">
	...
	<div class="buy_block">
		<div class="ctn-product-name" >
			<h1 id="name_unico_sin_estilo">{$product->name|capitalize}</h1>
		</div>
...
<div id="global" >
	<div id="conconImage">
		<div id="more_info_block" class="clear">
            ...
            <div id="scro"><h2 class="font-3">{$disponibilidad}</h2></span><p style="text-align: justify;" align="justify">&nbsp;</p>{$product->description_short}</div>
					</div>
				{/if}
