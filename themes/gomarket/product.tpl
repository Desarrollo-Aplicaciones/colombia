	...
	<div class="ctn-product-imgs">
		...
		{else} *}
			...
			<div id="image-block{if !$have_image || count($images) < 2}-static{/if}">
				<span id="view_full_size" >
					{if $have_image}
						<img  src="{$link->getImageLink($product->link_rewrite, $cover.id_image, 'large_default')}" {if $jqZoomEnabled}class="jqzoom" alt="{$legend_img|escape:'htmlall':'UTF-8'}" alt="{$legend_img|escape:'htmlall':'UTF-8'}" {/if} id="bigpic"/>
					{else}
						<img  src="{$img_prod_dir}{$lang_iso}-default-large_default.jpg" id="bigpic" alt="{$legend_img|escape:'htmlall':'UTF-8'}" title="{$product->name|escape:'htmlall':'UTF-8'}"/>
					{/if}
				</span>
				{if isset($isboton) && $isboton}
					<div class="btn-discount-purple" id="btn-discount-purple">
                   ...
                   <div id="modal-register-product" class="farma-modal">
                    <div class="modal-content">
                      <div class="modal-table">
                        ...
                        <div class="modal-table-cell modal-title">Dejanos tus datos de <br> contacto</div>
                        <div class="modal-table-cell modal-close"><span>&times;</span></div>
                      </div>
                      ...
                      <div class="response-modal" id="modal-thanks">
                        <div class="header-response-modal">
                          <div class="modal-table-cell"><img src="{$img_dir}Ok lightbox confirmacion.jpg" id="ok_img"></div>
                        ...
                        <div  class="message-response">
                            <span style="color:#3A9A37;font-size:14px;"> {$product->name} </span>
                        </div>
                        <div  class="message-response">
                        ...
                        <div class="message-response"> 
                          <span style="font-weight:bold;">Gracias por confiar en nosotros</span>
                        </div>
	...
	<div class="ctn-contact-movile" style="display: none;">
		...
		<div class="ctn-phone-number" id="desplegable" style=" display: none; ">
			<div class="row-call-now">
				<div class="txt-green">24 HORAS EN BOGOTÁ Y MEDELLÍN</div>
			</div>

			<div class="row-phone-number">
				<div class="phone-number-city"><span class="txt-phone-number"><strong>Bogotá:</strong> (+57 1) 492 6363</span></div>
				<div class="ctn-btn-call"><a href="tel:+5714926363"><div class="btn-call">Llamar</div></a></div>
			</div>
			<div class="row-phone-number">
				<div class="phone-number-city"><span class="txt-phone-number"><strong>Cali:</strong> (+57 2) 386 0083</span></div>
				<div class="ctn-btn-call"><a href="tel:+5723860083"><div class="btn-call">Llamar</div></a></div>
			</div>
			<div class="row-phone-number">
				<div class="phone-number-city"><span class="txt-phone-number"><strong>Medellín:</strong> (+57 4) 283 6150</span></div>
				<div class="ctn-btn-call"><a href="tel:+5742836150"><div class="btn-call">Llamar</div></a></div>
			</div>
			<div class="row-phone-number">
				<div class="phone-number-city"><span class="txt-phone-number"><strong>Barranquilla:</strong> (+57 5) 319 7970</span></div>
				<div class="ctn-btn-call"><a href="tel:+5753197970"><div class="btn-call">Llamar</div></a></div>
			</div>
			<div class="row-phone-number">
				<div class="phone-number-city"><span class="txt-phone-number"><strong>Nacional:</strong> 01 800 913 3830</span></div>
				<div class="ctn-btn-call"><a href="tel:018009133830"><div class="btn-call">Llamar</div></a></div>
			</div>
		</div>

		<div class="row-desplegable" id="active-whatsapp">
			<a href="tel://3219489664" class="href-whatsapp"> 
					...
					<ul id="idTab9" class="rte bullet content_hide_show"style="font-family: 'Open Sans', sans-serif;">
						{foreach from=$attachments item=attachment}
							<li>
								...
								<br/>{$attachment.description|escape:'htmlall':'UTF-8'}
							</li>
						{/foreach}
					</ul>
				{/if}
										...
										{if ($accessory.allow_oosp || $accessory.quantity > 0) AND $accessory.available_for_order AND !isset($restricted_country_mode)}
											...
											<li class="{if isset($grid_product)}{$grid_product}{else}grid_6{/if} ajax_block_product {if $smarty.foreach.accessories_list.first}first_item{elseif $smarty.foreach.accessories_list.last}last_item{else}item{/if} product_accessories_description clearfix">
												<div class="center_block">
													<div class="image">
														<a href="{$accessoryLink|escape:'htmlall':'UTF-8'}" title="{$accessory.name|escape:'htmlall':'UTF-8'}" class="product_img_link">
				...
				{if $product->description}
					...
					<div id="idTab1" class="rte content_hide_show">
						{if isset($isrequired) && $isrequired}
							<div id="info_confirm">
								<p>
									La información aquí contenida está dirigida exclusivamente para profesionales de la salud, es necesario confirmar que pertenece a este gremio para tener acceso a la misma.<br/><br/>
									<input type="checkbox" value="is_prof" id="is_prof" />
									<span onclick="$('#is_prof').trigger('click');"> Confirmo que soy un profesional de la salud.</span>
								</p>
								<a href="javascript:void(0)" onclick="if($('#is_prof').is(':checked'))$('#info_confirm').slideToggle();">
									<div>Mostrar información</div>
								</a>
							</div>
						{/if}
						<div id="scro">
...
<div id="care-lines">
	...
	<div class="lightbox_resume">
		<img src="{$img_dir}pdp/LIGHTBOX_TELEFONOS_COL.jpg">
