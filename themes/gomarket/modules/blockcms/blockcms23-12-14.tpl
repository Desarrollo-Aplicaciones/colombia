...
{else}
	...
	<div class="block_various_links" id="block_various_links_footer">
		...
		<ul class="f_block_content">
			...
			<li class="item"><a href="http://www.farmalisto.com.co/content/8-que-es-farmalisto" target="_self" title={l s='¿Qué es farmalisto?' mod='blockcms'}>{l s='¿Qué es farmalisto?' mod='blockcms'}</a></li>
