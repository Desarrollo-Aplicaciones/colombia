...
{if isset($empty)}
	...
	{if isset($smarty.cookies.validamobile)}
		<p class="warning">Por favor agregue productos para continuar</p>
	{/if}
								...
								<div class="cart_quantity">
									...
									{else}
										<div class="cart_quantity_button">
											<a rel="nofollow" class="cart_quantity_up" id="cart_quantity_up_{$product.id_product}_{$product.id_product_attribute}_{$id_customization}_{$product.id_address_delivery|intval}" href="{$link->getPageLink('cart', true, NULL, "add&amp;id_product={$product.id_product|intval}&amp;ipa={$product.id_product_attribute|intval}&amp;id_address_delivery={$product.id_address_delivery}&amp;id_customization={$id_customization}&amp;token={$token_cart}")}" title="{l s='Add'}">
												<img src="{$img_dir}icon/quantity_up.gif" alt="{l s='Add'}" width="11" height="11" />
											</a>
											<br/>
...
{* 		<div id="contenedor3contenidos">
			<div id="boxnefi">
  				...
  				<div class="boxnefi2">
  					<div id="imgdiscr">
  						<img src="{$img_dir}mediosp/g644.png"/>
  					</div>
  					<div class="beneficios">*Envío <b>gratis</b> por compras superiores a 
  						<span style="color:#b7689e"><b><br>$ 49.900</b></span>
  					</div>
  				</div>
  				<div class="boxnefi2">
  					<div id="imgdiscr">
  						<img src="{$img_dir}mediosp/g648.png"/>
  					</div>
  					<div class="beneficios">*<b>Absoluta</b> discreción</div>
  				</div>
  				<div class="boxnefi2">
  					<div id="imgdiscr">
  						<img src="{$img_dir}mediosp/g652.png"/>
  					</div>
  					<div class="beneficios">
  						* Mejor precio 
  						<a href="content/6-garantia-del-mejor-precio">
  							<span style="color:#b7689e;font-size:10px"><b>Garantizado*</b>
  							</span>
  						</a>
  					</div>
  				</div>
            ...
            <div id="cupon">
            	{if $voucherAllowed}
            		...
            		<form action="{if $opc}{$link->getPageLink('order-opc', true)}{else}{$link->getPageLink('order', true)}{/if}" method="post" id="voucher">
            			<fieldset>
            				<p>Ingresa el nombre de tu </p>
            				<input type="radio" name="type_voucher" value="md" > Médico o el 	
                            <input type="radio" name="type_voucher" value="cupon" checked="checked"> Cupón promocional
                            <p>
                    ...
                    {if $displayVouchers}
                    	...
                    	<div id="display_cart_vouchers">
                    		{foreach $displayVouchers as $voucher}
                    			{if $voucher.code != ''}
                    				<span onclick="$('#discount_name').val('{$voucher.code}');return false;" class="voucher_name">{$voucher.code}
                    				</span> - 
                    			{/if}
                    			{$voucher.name}
                    			<br/>
			...
			{* <div class="en_cuenta">
		     	...
		     	<ul>
		     		<li class="mind_content">- <b>Bogotá:</b> Envío <b>gratis</b> por compras superiores a <b>$50.000</b>. Por compras inferiores el costo será de <b>$1.000</b>.
		     			<li class="mind_content">- <b>Principales Ciudades:</b> Para todos los pedidos el costo será de <b>$7.800</b></li>
		     			<li class="mind_content">- <b>Trayectos Especiales:</b> Para todos los pedidos el costo será de <b>$28.000</b></li>
		     			<li class="mind_content">- Medios de Pago: <b>Efectivo</b> (Aplica en Bogotá)<b>, Tarjetas débito, Tarjetas crédito, Efecty y Baloto</b></li>
		     			<li class="mind_content">- ** Al agregar este producto es posible que el plazo de nuestra promesa de entrega se extienda. Agrega este producto y al finalizar tu pedido ponte en contacto con nuestro servicio al cliente para determinar la hora de entrega.</li>
		     		</ul>
		     	</div> *}
	...
	{* 	     		{if $use_taxes}
		     			{if $priceDisplay}
		     				<div class="cart_total_price" >
		     					<div  id="primerLabel"  style="padding-bottom: 0px;">
...
{if isset($smarty.cookies.validamobile)}
	{if $validationstep != 0 && $validationstep != -1}
		...
		<a  id="atras1" href="/" class="button_large" title="{l s='Continue shopping'}">
		{l s='Return to shop'}</a>
	{/if}
{else}
	{* <a  id="atras1" href="{if (isset($smarty.server.HTTP_REFERER) && strstr($smarty.server.HTTP_REFERER, 'order.php')) || isset($smarty.server.HTTP_REFERER) && strstr($smarty.server.HTTP_REFERER, 'order-opc') || !isset($smarty.server.HTTP_REFERER)}{$link->getPageLink('index')}{else}{$smarty.server.HTTP_REFERER|escape:'htmlall':'UTF-8'|secureReferrer}{/if}" class="button_large" title="{l s='Continue shopping'}">*}
	{* <a  id="atras1" href="{$base_uri}" class="button_large" title="{l s='Continue shopping'}">
		{l s='Return to shop'}</a> *}
{/if}
