...
{/if}
		...
		<script type="text/javascript">
			...
			var roundMode = {$roundMode};
                        var ruta = "//www.farmalisto.com.co/ajax_newsletter.php"; 
		</script>
...
{* PERFILES SOCIALES EN SEARCH *}
<script type="application/ld+json">
{
	"@context" : "http://schema.org",
	"@type" : "Organization",
	"name" : "Farmalisto",
	"url" : "//www.farmalisto.com.co/",
	"sameAs" : [
		"https://www.facebook.com/farmalistocolombia",
		"https://twitter.com/farmalistocol",
		"https://plus.google.com/+FarmalistoColombia/videos",
		"https://www.youtube.com/user/farmalistocolombia",
...
{/literal*}
	...
	{if $lightbox_horario_call == 1 && !isset($smarty.cookies.Cooklightbox_horario_call) }
		<div id="lightbox_horario_call" style="display:none;">
			...
			<a href="//www.farmalisto.com.co/content/55-Horarios-Diciembre">
				<img id="img_lightbox_horario_call_1" src="{$base_dir}img/Licghtbox-horario-diciembre-desktop-col.jpg" style="width:90%;"/>
				<img id="img_lightbox_horario_call_2" src="{$base_dir}img/Lightbox-horario-diciembre-movil-col.jpg" style="width:90%; display:none;"/>
			</a>
		</div>
		<script type="text/javascript">
			$('document').ready( function(){
