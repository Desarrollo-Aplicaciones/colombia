...
if (isset($_POST)) {
  ...
  if (isset($_POST['accion']) && $_POST['accion'] != '') {
    ...
    switch ($accion) {
      ...
      //        POST [txtSearch, pri[], add_products_out_order, id_emp, id_cart, id_order, accion]        //
      ...
      case 'ajaxIcrAddOutOrder':    // Paso 2.-  Agregando un ICR a una order de salida; POST [opcion, accion, cod_icr, id_orden] //
  ...
  }   //  En el caso de que se agregue un ICR a una orden de salida  //
    ...
    if (isset($_POST['id_supply_order']) && $_POST['id_supply_order'] != '' && isset($_POST['opcion'])) {
      ...
      if ($_POST['opcion'] == "save") {  // Agregando los ICRs a la orden de suministro  //
        ...
        if ($prodsValidos == 1 && $icrValidos == 1) {
          ...
          if ($prodsValidos == 0) {
            echo "<u> valide la asociación al proveedor, </u>";
          }
          if ($icrValidos == 0) {
            echo "<u> valide que los ICR estén en estado 1 ( creado ), </u>";
          }
        ...
        if ($prodsValidos == 1 && $icrValidos == 1) {
          ...
          echo "<br>cant_pro:" . count($arrprods);
          if ($prodsValidos == 0) {
            echo "<u> valide la asociación del producto con el proveedor, </u>";
          }
          if ($icrValidos == 0) {
            echo "<u> valide que los ICR estén en estado 2 ( Asignado ), </u>";
          }
