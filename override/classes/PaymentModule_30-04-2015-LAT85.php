...
//valida si tiene doble descuento tanto en la entrada de direccion como en cupon de envio adentro del back office
                    ...
                    if ($descuento != "" && $descuento != 0){
                        ...
                        $order->total_paid = $totalorderdescuento['total'] + $order->total_shipping;
                        $order->total_paid_tax_excl = $totalorderdescuento['total'] + $order->total_shipping;
                        $order->total_paid_real = $totalorderdescuento['total'] + $order->total_shipping;
                        $order->total_paid_tax_incl = $totalorderdescuento['total'] + $order->total_shipping;
                    }
