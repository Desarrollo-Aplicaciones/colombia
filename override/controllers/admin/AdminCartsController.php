...
/*	if(isset($this->context->cart->id) && isset($this->context->employee->id) && (int)$this->context->cart->id_employee == 0 ) {
		...
		if (count($cart_rules))
			foreach ($cart_rules as $cart_rule)
				...
				for($i=0; $i <count($address); $i++){
					if(Utilities::is_rules_entrega_nocturna() && Utilities::is_city_address($address[$i]['id_address']) ){
