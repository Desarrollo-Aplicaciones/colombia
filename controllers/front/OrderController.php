...
class OrderControllerCore extends ParentOrderController
{
	...
	{
		// Validacion de paso actual del carrito
		$this->context->smarty->assign('validationstep', $this->context->controller->step);
...
$cities = array("1184", "1503","1592","1498","1534","1537","1507","1528","1510","1493","1573","1560","1563");
