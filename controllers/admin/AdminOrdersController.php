...
class AdminOrdersControllerCore extends AdminController {
  ...
  public function sendChangedNotification(Order $order = null) {
    ...
    Mail::Send(
        (int) $order->id_lang, 'order_changed', Mail::l('Your order has been changed', $order->id_lang), $data, $order->getCustomer()->email, $order->getCustomer()->firstname . ' ' . $order->getCustomer()->lastname, null, null, null, null, _PS_MAIL_DIR_, true, (int) $order->id_shop);
  }
