...
$client = new JSON_WebClient("http://192.168.10.82/test.farmalisto.com.co/wspro/webservicemobile.php");
...
if (isset($_POST) && $_POST) {
    ...
    switch ($_POST['metodo']) {
        ...
        case 'getProductos':
            ...
            $client->call("getProductos", array("Buscar" => utf8_encode($_POST['buscar']), 'Pagina' => '2', 'Filas' => '20', 'Ordenar' => 'A', 'Campo' => 'reference'), "onSucceededCallback", "onErrorCallback");
		}else{
