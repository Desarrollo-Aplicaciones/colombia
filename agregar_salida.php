  ...
  <html>
    ...
    <form action="icrassoc.php" method="POST" id="form_target">
      <div  style=" width: 100%; height: 95%;">
        <div style="width: 100%; margin: -21px 0px 0px 0px; font-family: verdana; font-size: 12px; color: dimgray;"><h1>Orden De Salida # <?php printf("%04d", $id_order); ?> | <?php
  ...
  ?>
      ...
      if (event.keyCode == 13) {
        ...
        if (!ordenCompleta())
        {
          ...
          if (icr != '')  // fin campo vacio
          {
            ...
            console.log("Paso 1.- de carga ICRs de Salida, Ruta: ", ruta);
            $.ajax({
              type: "post",
              url: ruta,
              data: {
              ...
              success: function (response) {
                console.log("Rta retornda por el AJAX a icrassoc.php : " + response);
                    ...
                    if (response != 'NOFEC') {
                      ...
                      if (position == -1)
                      {
                        ...
                        if (productos["cont_" + retornado[4]] <= productos["total_" + retornado[4]])
                        {
                          ...
                          console.log("RETORNADO: ", retornado.toString());
    ...
    function ordenCompletaGuargar() {
      ...
      if (ordenCompleta())
      {
        ...
        if (r == true)
        {
          //  Envia el formulario a icrassoc.php, POST [txtSearch, pri[], add_products_out_order, id_emp, id_cart, id_order, accion]
          $("#form_target").submit();
        } else
        {
