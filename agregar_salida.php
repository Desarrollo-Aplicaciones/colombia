  ...
  <html>
    ...
    <form action="icrassoc.php" method="POST" id="form_target">
      <div  style=" width: 100%; height: 95%;">
        <div style="width: 100%; margin: -21px 0px 0px 0px; font-family: verdana; font-size: 12px; color: dimgray;"><h1>Orden De Salida # <?php printf("%04d", $id_order); ?> | <?php if (isset($_GET['opcion'])) {
