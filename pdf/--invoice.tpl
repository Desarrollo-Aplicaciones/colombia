...
<table style="width: 100%; font-size: 8pt;">
				...
				{* Eliminar mostrar descuentos foreach $cart_rules as $cart_rule}
					{cycle values='#FFF,#DDD' assign=bgcolor}
            ...
            <table style="width: 100%">
				...
				<tr style="line-height:5px;">
					<td style="text-align: right; font-weight: bold"> {if $apoyosalud!=NULL}{$apoyosalud}{/if}{*l s='Total Vouchers' pdf='true'*}</td>
